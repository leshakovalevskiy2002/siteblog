...
class Event(models.Model):
    ...
    description= models.CharField(help_text=_("A description of the event that occurred"),
    ...
    def save(self, *args, **kwargs):
        self.description = _("%(user)s %(type)s the %(group)s group") % {"user": self.user, "type": self.type, "group": self.group.name}
